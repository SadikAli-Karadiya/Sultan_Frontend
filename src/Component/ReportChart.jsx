...
import { getMonthWiseReport } from "../utils/apiCalls";
...
function ReportChart() {
  ...
  const reportChartData = useQuery(
    ["phonesChart"],
    getMonthWiseReport
  );
  ...
  React.useEffect(() => {
    if (reportChartData.isSuccess) {
      let ProprtyName = Object.keys(reportChartData.data.data.data);
      let newData = Object.values(reportChartData.data.data.data);
